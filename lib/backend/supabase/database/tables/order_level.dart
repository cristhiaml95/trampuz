...
class OrderLevelRow extends SupabaseDataRow {
  OrderLevelRow(Map<String, dynamic> data) : super(data);
  ...
  String get associatedOrder => getField<String>('associated_order')!;
  set associatedOrder(String value) =>
      setField<String>('associated_order', value);
  ...
  String? get associatedOrderNo => getField<String>('associated_order_no');
  set associatedOrderNo(String? value) =>
      setField<String>('associated_order_no', value);
  ...
  int? get detailsAvailable => getField<int>('details_available');
  set detailsAvailable(int? value) => setField<int>('details_available', value);
  ...
  bool get isDeletedBefore => getField<bool>('is_deleted_before')!;
  set isDeletedBefore(bool value) => setField<bool>('is_deleted_before', value);

  double get groupConsumedThreshold =>
      getField<double>('group_consumed_threshold')!;
  set groupConsumedThreshold(double value) =>
      setField<double>('group_consumed_threshold', value);
}
