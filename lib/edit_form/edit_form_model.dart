...
class EditFormModel extends FlutterFlowModel<EditFormWidget> {
  ...
  int quantityBalanceInt = 0;

  ///  State fields for stateful widgets in this page.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Backend Call - API (orderWarehouseT)] action in editForm widget.
  ApiCallResponse? outOrdersFromInEFOP;
  // Stores action output result for [Backend Call - API (orderWarehouseT)] action in editForm widget.
  ApiCallResponse? inOrderFromOutEFOP;
  // Stores action output result for [Backend Call - API (orderWarehouseT)] action in editForm widget.
  ApiCallResponse? outOrdersFromInFromOutEFOP;
  // Stores action output result for [Backend Call - API (orderWarehouseT)] action in editForm widget.
  ApiCallResponse? outPlusInOrdersFromInEFOP;
  // Stores action output result for [Backend Call - API (orderWarehouseT)] action in editForm widget.
  ApiCallResponse? fatherOrderOP;
  // Stores action output result for [Custom Action - quantityBalanceAction] action in editForm widget.
  int? quantityBalance;
  ...
  // Stores action output result for [Backend Call - API (refreshOrderLevelCalculatedColumns)] action in Button widget.
  ApiCallResponse? refreshRowOPCopy3;
  // Stores action output result for [Backend Call - Insert Row] action in Button widget.
  ...
  // State field(s) for barcodesCheck widget.
  bool? barcodesCheckValue;
  ...
  // State field(s) for barcodes2TF widget.
  FocusNode? barcodes2TFFocusNode;
  TextEditingController? barcodes2TFTextController;
  String? Function(BuildContext, String?)? barcodes2TFTextControllerValidator;
  ...
  String? _customPercentageTFTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '64iaaaxm' /* Velue between 0 and 100 is req... */,
      );
    }
    ...
    if (!RegExp(
        ...
        .hasMatch(val)) {
      return FFLocalizations.of(context).getText(
        'y1ecbzlb' /* Velue between 0 and 100 is req... */,
      );
    }
    return null;
  }
  ...
  // State field(s) for quantityBalanceTF widget.
  FocusNode? quantityBalanceTFFocusNode;
  TextEditingController? quantityBalanceTFTextController;
  String? Function(BuildContext, String?)?
      quantityBalanceTFTextControllerValidator;
  ...
  // State field(s) for useTodayExchangeTypeCheck widget.
  bool? useTodayExchangeTypeCheckValue;
  // Stores action output result for [Backend Call - API (refreshOrderLevelCalculatedColumns)] action in PlutoGridEditForm widget.
  ApiCallResponse? refreshRowEFOP;
  // Stores action output result for [Backend Call - Insert Row] action in PlutoGridEditForm widget.
  OrderLevelRow? insertedRowEFOP;
  // Stores action output result for [Backend Call - API (refreshOrderLevelCalculatedColumns)] action in PlutoGridEditForm widget.
  ApiCallResponse? refreshRow2EFOP;
  // Stores action output result for [Backend Call - Insert Row] action in PlutoGridEditForm widget.
  OrderLevelRow? insertedRow2EFOP;
  ...
  void dispose() {
    ...
    barcodes2TFFocusNode?.dispose();
    barcodes2TFTextController?.dispose();
    ...
    quantityBalanceTFFocusNode?.dispose();
    quantityBalanceTFTextController?.dispose();
  }
}
