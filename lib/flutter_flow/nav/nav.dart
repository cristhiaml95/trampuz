...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? OrderWarehouseWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: Warehouse2Widget.routeName,
          path: Warehouse2Widget.routePath,
          builder: (context, params) => Warehouse2Widget(
            warehouse2TablesKey: params.getParam(
              'warehouse2TablesKey',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => ExploreWidget(
            exploreWarehousesKey: params.getParam(
        ...
        FFRoute(
          ...
          builder: (context, params) => ReportsWidget(
            orderWarehouseTablesKey: params.getParam(
              'orderWarehouseTablesKey',
              ParamType.String,
            ),
            numberOfRows: params.getParam(
              'numberOfRows',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          name: OrderWarehouseWidget.routeName,
          path: OrderWarehouseWidget.routePath,
        ...
        FFRoute(
          name: CustomsViewWidget.routeName,
          path: CustomsViewWidget.routePath,
          builder: (context, params) => CustomsViewWidget(
            orderWarehouseTablesKey: params.getParam(
              'orderWarehouseTablesKey',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: NewFormWidget.routeName,
          path: NewFormWidget.routePath,
          builder: (context, params) => NewFormWidget(
            viewFrom: params.getParam(
              'viewFrom',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => EditFormWidget(
            orderJson: params.getParam(
              'orderJson',
              ParamType.DataStruct,
              isList: false,
              structBuilder: OrderWarehouseRowStruct.fromSerializableMap,
            ),
            viewFrom: params.getParam(
              'viewFrom',
              ParamType.String,
